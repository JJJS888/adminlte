...
/*
if (!$_SESSION["tipo"])
if (isset($_SESSION["tipo"]) === 'administrador' || $_SESSION["tipo"] === 'empleado'){
...
*/
 ...
 exit();
  ...
  if (isset($_REQUEST["sesion"]) && $_REQUEST[
 "sesion"] === "cerrar") {
 session_unset();
 session_destroy();
 ...
 <link rel="stylesheet" href="https://cdn.datatables.net/1.13.6/css/jquery.dataTables.min.css">
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
            ...
            <!--begin::User Menu Dropdown-->
                ...
                <li>
                   ...
                   <?php 
                    ...
                    ?>
                    <span class ="d-none d-md-inline">Anonimo</span>
                    <?php }?>
                    </span>
                </li>
                <li class="nav-item">
                 <a class="nav-link" href="?sesion=cerrar" title="Cerrar sesión">
              ...
              <li class="nav-item menu-open">
               <a href="#" class="nav-link active"> 
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                  <a href="index.php?modulo=usuarios" class="nav-link active">
                    <i class="bi bi-people"></i>
                      <p>Usuario</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="index.php?modulo=productos" class="nav-link active">
      ...
      <main class="app-main">
      <?php
        $modulo = isset($_GET['modulo'])  ?  $_GET['modulo'] : 'panel_inicio';
        
        if ($modulo == "panel_inicio"){
          include "panel_inicio.php";
        }
        if ($modulo == "clientes") {
        ...
        if ($modulo == "insertarCliente") {

          include "insertarCliente.php";
        
        } 
        if ($modulo == "eliminarCliente") {
