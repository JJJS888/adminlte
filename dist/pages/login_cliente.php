...
//echo $clave;
$sql = "SELECT id, nombre, apellido, email FROM clientes WHERE email ='$email' AND clave='$clave'";
//echo $sql;
...
$errorLogin = true;
echo "<script>alert('Error: Cliente o contraseña incorrecta');</script>";
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                 <center><h3 class="card-title" style="margin-top:25px;"><b>LOGIN_CLIENTES</b></h3></center>
</div>
              ...
              <div class="card-body" style="margin-top:75px;" >
                ...
                <center>
                  ...
                  <br>
                  <a href="login_usuario.php">Login_Admin</a>
                  <br>
