...
include_once "./controles/con_usuarios.php";
    ...
    <table id="tabla" class="table table-bordered">
        ...
        <thead>
            <tr>
                ...
                <th>clave</th>
                <th>tipo</th>
                <th><a href="index.php?modulo=crearUsuario"><i class="bi bi-database-add" ></i></a></th>
        ...
        <?php while($row = mysqli_fetch_assoc($resultset)): ?>
            <tr>
                ...
                <td><a href="index.php?modulo=editarUsuario&id=<?php echo $row["id"]?>"><i class="bi bi-pencil"></i></a>&nbsp<?php if ($_SESSION["tipo"] === "administrador"){echo '<a href="index.php?modulo=eliminarUsuario&id= echo $row["id"]> <i class="bi bi-trash3"></i></a>';} ?></td>   
            </tr>
        <?php endwhile; ?>
        </tbody>
    </table>
